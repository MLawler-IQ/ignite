...
<div class="iiq-mk-shell" style="display:grid; grid-template-columns:240px 1fr; min-height:460px; font-family: system-ui, -apple-system, sans-serif;">
  <aside class="iiq-mk-aside" style="background:#F6F8FC; border-right:1px solid #E5E7EB; padding:14px 0;">
    ...
    <button style="margin:0 16px 18px; padding:10px 18px; background:#C2E7FF; color:#001D35; border:none; border-radius:16px; font-family:inherit; font-size:14px; font-weight:600; display:flex; align-items:center; gap:10px; cursor:pointer;">
      <span style="font-size:16px;">&#9998;</span> Compose
    </button>
    <div style="display:flex; align-items:center; justify-content:space-between; padding:7px 16px 7px 24px; background:#D3E3FD; font-size:14px; font-weight:700; color:#001D35; border-radius:0 16px 16px 0; margin-right:12px;">
      <span style="display:inline-flex; align-items:center; gap:12px;">Inbox</span>
      <span style="font-size:12px; font-weight:700;">12</span>
    </div>
    <div style="display:flex; align-items:center; justify-content:space-between; padding:7px 16px 7px 24px; background:transparent; font-size:14px; font-weight:400; color:#1F1F1F; border-radius:0; margin-right:12px;">
      <span style="display:inline-flex; align-items:center; gap:12px;">Starred</span>
    </div>
    <div style="display:flex; align-items:center; justify-content:space-between; padding:7px 16px 7px 24px; background:transparent; font-size:14px; font-weight:400; color:#1F1F1F; border-radius:0; margin-right:12px;">
      <span style="display:inline-flex; align-items:center; gap:12px;">Sent</span>
    </div>
    <div style="display:flex; align-items:center; justify-content:space-between; padding:7px 16px 7px 24px; background:transparent; font-size:14px; font-weight:400; color:#1F1F1F; border-radius:0; margin-right:12px;">
      <span style="display:inline-flex; align-items:center; gap:12px;">
        <span style="width:8px; height:8px; border-radius:50%; background: var(--ignite-500);"></span>
        IgniteIQ
      </span>
      <span style="font-size:12px; font-weight:400;">1</span>
    </div>
  </aside>
    ...
    <div style="border-bottom:1px solid #E5E7EB;">
      <div class="iiq-mk-maillist" style="display:grid; grid-template-columns:170px 1fr 70px; gap:16px; padding:11px 18px; border-bottom:1px solid #F1F3F4; background:#EAF1FB; font-size:13.5px; color:#1F1F1F; font-weight:700; align-items:baseline; position:relative;">
        ...
        <span style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
          <b style="color:#1F1F1F; font-weight:700;">Your Tuesday Morning Brief &mdash; May 28</b><span style="color:#5F6368; font-weight:400;"> &mdash; 3 going right &middot; 2 needing attention &middot; 1 decision required today</span>
        </span>
    ...
    <div style="padding:20px 24px; flex:1;">
      ...
      <div class="iiq-mk-2col" style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-top:4px;">
        <div style="padding:12px 14px; background:#E6F4EA; border-left:3px solid #137333; border-radius:4px;">
          ...
          <div style="font-size:13px; line-height:1.55; color:#202124;">
            Booked revenue up <b>12.4%</b> WoW. Membership renewals are running ahead of plan. Callback rate down to <b>3.1%</b>.
          </div>
        </div>
        <div style="padding:12px 14px; background:#FCE8E6; border-left:3px solid #C5221F; border-radius:4px;">
          <div style="font-size:11px; font-weight:700; color:#C5221F; letter-spacing:0.06em; text-transform:uppercase; margin-bottom:6px;">
            ! Needs attention
          </div>
          <div style="font-size:13px; line-height:1.55; color:#202124;">
            Q2 install margin tracking <b>2.4 pts</b> below plan. Driver: Yelp channel jobs running 6 pts under target margin.
          </div>
        </div>
      </div>
      <div style="margin-top:14px; padding:12px 14px; background:#FFF8E1; border:1px solid var(--ignite-500); border-radius:4px; font-size:13.5px; line-height:1.55; color:#202124;">
        <div style="font-size:11px; font-weight:700; color: var(--ignite-600); letter-spacing:0.06em; text-transform:uppercase; margin-bottom:6px;">&#9679; Decision required today</div>
        Approve a <b>$4,200 budget shift</b> from Yelp &rarr; Google Local. Forecast lift: <b>+11 booked jobs / week</b>.
        <a href="#" style="color:#1A73E8; margin-left:6px; text-decoration:none; font-weight:600;">Review &rarr;</a>
      </div>
    </div>
  </div>
</div>
